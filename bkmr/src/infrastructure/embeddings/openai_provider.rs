...
/// New code should use `OpenAiCompatibleEmbedding` with default settings or `OPENAI_PROVIDER=openai`:
/// 
/// ```bash
/// export OPENAI_API_KEY="sk-..."
/// # OPENAI_PROVIDER defaults to "openai" if not set
/// ```
#[deprecated(
    since = "6.3.0",
    note = "Use OpenAiCompatibleEmbedding instead"
)]
#[derive(Debug, Clone)]
